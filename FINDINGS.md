...
- [ ] **USPTO patent assignment records for the Mitradyne family.** `assignment-api.uspto.gov` does not resolve from this host. **The single most likely place a university stake or security interest would appear.** Highest-value remaining item on Mitradyne
